...
class AES{
    ...
    /** 
     * 构造函数
     * @param boolean hex 结果是否以十六进制显示，true：显示
     * @param boolean debug 是否打印调试信息 true：打印调试信息
     */
	 ...
	 * 【描述】
	 * 
	 * @param 返回加密后的字符串 $excodeStr 加密字符串
	 * @param 返回加密后的字符串 $expandedKeys 被加密的字符串
